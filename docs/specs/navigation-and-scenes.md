...
- **REQ-STAGESEL-001** — `StageSelectScene` shall render the 9 stages as 9 test tubes in a rack,
  grouped 3-per-sector, reading the difficulty from the registry and the unlock state from
  `SaveSystem`.
