...
// Every in-scope sprite is a PNG under `public/assets/sprites/`, loaded by key in preload(). Most are
// hand-drawn; the ★ enemies/bosses, the noble gem, and the pickup drops are rasterized from
// scripts/gen-sprites.mjs (see that file). Game code references these textures only by key, so the
// art lives entirely here. Stage maps (bg_tile / ground_tile) and the vignette stay procedural — see
...
const ASSET_SPECS: AssetSpec[] = [
  ...
  // Pickup drops (generated by scripts/gen-sprites.mjs alongside the ★ art)
  { key: 'atom_platinum', file: 'atoms/atom_platinum.png' },
  { key: 'atom_calcium', file: 'atoms/atom_calcium.png' },
  { key: 'atom_zinc', file: 'atoms/atom_zinc.png' },
  { key: 'atom_iron', file: 'atoms/atom_iron.png' },
  { key: 'coin_silver', file: 'atoms/coin_silver.png' },
